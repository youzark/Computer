...
-- telescope
vim.api.nvim_set_keymap('n','<leader>h','<cmd>Telescope help_tags<cr>',silent)
...
vim.api.nvim_set_keymap('n','gf',',w<cmd>lua require("telescope.builtin").find_files({hidden=true})<CR>',silent)
